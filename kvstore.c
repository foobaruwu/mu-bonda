...
void kv_put(unsigned int key,unsigned int value, unsigned int is_signed){
    ...
    unsigned long long entry = ((unsigned long long)key&0xFFFFFFFF) | (((unsigned long long)value&0xFFFFFFFF)<<31) |(((unsigned long long)is_signed&0x1)<<63);
...
void kv_delete(unsigned int key){
    ...
    unsigned long long entry = ((unsigned long long)key&0xFFFFFFFF) | (1ULL<<62);
    kv_log[kv_index++]=(kv_entry_t){entry};
